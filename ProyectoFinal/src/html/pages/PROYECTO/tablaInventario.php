<!-- /* script PHP que requiere un archivo de utilidad de base de datos y verifica
la existencia de una variable de sesión "tipoUsuario". Si la variable existe y su valor no es
"adminTienda" o "superAdmin", el usuario es redirigido a la página de inicio de sesión. Si la
variable no existe, el usuario también es redirigido a la página de inicio de sesión. */ -->
<?php
...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                                ...
                                <div class="components-preview wide-md mx-auto">     
                                    <div class="nk-block nk-block-lg">
                                        ...
                                        <?php }else{ ?> 
                                            ...
                                            <br>
                                            <!-- /* tabla de productos con sus detalles, como código, nombre, fecha de adición,
                                            precio, categoría y existencias. Está utilizando PHP para recorrer una variedad de productos y mostrar sus
                                            detalles en las filas de la tabla. También incluye un menú desplegable para cada producto con opciones para
                                            editar, ver detalles y eliminar el producto. */ -->
                                                    ...
                                                    <?php foreach ($r as $fila): ?>
                                                        <tr class="tb-odr-item">
                                                            <td class="tb-odr-info">
                                                                <span class="tb-odr-id"><a href="#"><?php echo $fila['codigo_producto']; ?></a></span> <!--obtener codigo-->
                                                                <span class="tb-odr-date"><?php echo $fila['nombre_producto']; ?></span> <!--obtener nombre-->
                                                            </td>   
                                                        <td class="tb-odr-amount"> 
                                                        <span class="tb-odr-status">
                                                            <span class="tb-odr-date"><?php echo $fila['date_add']; ?></span> <!--obtener fecha de agregado-->
                                                        </span>
                                                        </td>
                                                        <td class="tb-odr-amount"> 
                                                        <span class="tb-odr-status">
                                                            <span class="tb-odr-date"><?php echo $fila['precio_producto']; ?></span> <!--obtener precio-->
                                                        </span>
                                                        </td>
                                                        <td class="tb-odr-amount"> 
                                                        <span class="tb-odr-status">
                                                            <span class="tb-odr-date"><?php echo $fila['nombre_categoria']; ?></span> <!--obtener categoria-->
                                                        </span>
                                                        </td>
                                                        <td class="tb-odr-amount"> 
                                                        <span class="tb-odr-status">
                                                            <span class="tb-odr-date"><?php echo $fila['stock']; ?></span> <!--obtener stock-->
                                                        </span>
                                                        </td>
                                                        
                                                        <!-- /* El código anterior genera un menú desplegable con tres opciones (Editar, Detalles y Eliminar) para un producto en una
                                                        página web. Los enlaces en el menú desplegable se generan dinámicamente usando PHP para pasar la ID del producto y la ID de
                                                        la tienda como parámetros. */ -->
    ...
    <!-- app-root @e -->
     ...
     entrada de contraseña. También incluye un botón para eliminar un producto y un mensaje de
     advertencia si la contraseña es incorrecta. El modal se desencadena por un evento externo, como
     un clic en un botón. */ -->
    ...
    <!-- /* script JavaScript que muestra una ventana modal cuando se llama.
    ...
    los valores coinciden, abre una nueva ventana con una URL que incluye los valores de las
    variables "id" e "id_tienda". Si los valores no coinciden, muestra un mensaje "¡Datos
