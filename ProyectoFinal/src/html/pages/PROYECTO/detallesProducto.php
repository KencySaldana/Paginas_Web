<!-- /* Se implementa un sistema para administrar el stock de productos en una
tienda. Primero verifica si el usuario tiene los permisos necesarios para acceder a la página y
luego recupera la ID de la tienda y el producto de los parámetros de la URL. Si se envía un
formulario con una acción de "agregó" (añadido) o "vendió" (vendido), actualiza el stock del
producto en consecuencia y agrega un registro al historial de transacciones de la tienda. El usuario
que realizó la transacción también se registra en el historial, junto con cualquier información
adicional proporcionada en el formulario. Finalmente, recupera la */ -->
...
<?php
    ...
    if (isset($_POST['accion'])) {
        ...
        if ($accion == 'agregó') {
          ...
          if(decrementar_stock($id_producto, $_POST['unidades'])!=false) {
        ...
        <div class="nk-main ">
            ...
            <div class="nk-wrap ">
                ...
                <div class="nk-content ">
                            ...
                            <div class="nk-content-body">
                                ...
                                "responsive":[ {"breakpoint": 1539,"settings":{"slidesToShow": 4}}, {"breakpoint": 768,"settings":{"slidesToShow": 3}}, {"breakpoint": 420,"settings":{"slidesToShow": 2}} ]
                                                ...
                                                <div class="col-lg-6">
                                                        ...
                                                        <!-- /* código PHP que recorre una serie de productos () y
                                                        muestra sus detalles (nombre, código, ID, precio y existencias) en un formato de lista
                                                        desordenada utilizando clases HTML y CSS. */ -->
                                                        <?php foreach ($r as $fila): ?>
                                                            <ul class="nk-nav nk-nav-pills">
                                                                <li class="nk-menu-item">
                                                                    <a href="#" class="nk-menu-link">
                                                                        <span class="nk-menu-icon"><em class="icon ni ni-user"></em></span>
                                                                        <span class="nk-menu-text">Nombre: <?php echo $fila['nombre_producto']; ?></span> <!-- /* nombre del producto */ -->
                                                                    </a>
                                                                </li>
                                                                <li class="nk-menu-item">
                                                                    <a href="#" class="nk-menu-link">
                                                                        <span class="nk-menu-icon"><em class="icon ni barcode-scan"></em></span>
                                                                        <span class="nk-menu-text">Código: <?php echo $fila['codigo_producto']; ?></span> <!-- /* código del producto */ -->
                                                                    </a>
                                                                </li>
                                                                <li class="nk-menu-item">
                                                                    <a href="#" class="nk-menu-link">
                                                                        <span class="nk-menu-icon"><em class="icon ni ni-id-card"></em></span>
                                                                        <span class="nk-menu-text">ID: <?php echo $fila['id_producto']; ?></span>   <!-- /* ID del producto */ -->
                                                                    </a>
                                                                </li>
                                                                <li class="nk-menu-item">
                                                                    <a href="#" class="nk-menu-link">
                                                                        <span class="nk-menu-icon"><em class="icon ni ni-money"></em></span>
                                                                        <span class="nk-menu-text">Precio: $<?php echo $fila['precio_producto']; ?></span> <!-- /* precio del producto */ -->
                                                                    </a>
                                                                </li>
                                                                <li class="nk-menu-item">
                                                                    <a href="#" class="nk-menu-link">
                                                                        <span class="nk-menu-icon"><em class="icon ni ni-box"></em></span>
                                                                        <span class="nk-menu-text">Stock disponible: <?php echo $fila['stock']; ?></span> <!-- /* existencias del producto */ -->
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        <?php endforeach; ?>
                                                        <!-- /* formulario HTML con código PHP incrustado. Se utiliza para
                                                        agregar o quitar stock de un producto en una tienda. El formulario toma entrada para la
                                                        referencia y las unidades del producto y tiene dos botones para agregar o eliminar el
                                                        stock. El código PHP se usa para pasar la ID del producto y la ID de la tienda como
                                                        parámetros en la URL de acción del  formulario. */ -->
                                                        <form action="html/pages/PROYECTO/detallesProducto.php?p=<?php echo($fila['id_producto']);?>&t=<?php echo($id_tienda);?>" method="POST" id="detalles">
                                                        
                                                            <ul class="list-plain">
                                                                <li>
                                                                <span>Referencia</span><br>
                                                                <input type="text" class="form-control" name="referencia" id="referencia" aria-required="true"> <!-- /* referencia del producto */ -->
                                                                </li>
                                                                <li>
                                                                <span>Unidades</span><br>
                                                                <input type="text" class="form-control" name="unidades" id="unidades" aria-required="true"> <!-- /* unidades del producto */ -->
                                                                </li>
                                                            </ul>
                                                            <div class="nk-fmg-actions">
                                                                ...
                                                                <li>
                                                                    <button type="submit" name="accion" value="agregó" id= 'elimino' class="btn btn-light"> <!-- /* botón para agregar stock */ -->
                                                                    <em class="icon ni ni-plus"></em>
                                                                    <span>Agregar stock</span>
                                                                    </button>
                                                                </li>
                                                                <li>
                                                                    <button type="submit" name="accion" value="vendió" id= 'elimino' class="btn btn-primary"> <!-- /* botón para eliminar stock */ -->
                    ...
                    <!-- /* tabla de productos con su respectiva
                    información como fecha, nota, referencia y cantidad. Los datos se obtienen de
                    una variable de PHP llamada  mediante un bucle foreach. La tabla
                    se muestra usando clases HTML y CSS. */ -->
                    <div class="nk-wrap ">
                        <div class="nk-content-inner">
                            <div class="nk-content-body">
