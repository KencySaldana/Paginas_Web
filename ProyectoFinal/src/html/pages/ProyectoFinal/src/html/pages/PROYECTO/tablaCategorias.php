...
la página de inicio de sesión. También recupera y muestra categorías para una tienda específica,
permite la eliminación de categorías y registra la eliminación en una base de datos. Además,
recupera la contraseña del usuario actual y el nombre de la tienda en función del ID de tienda
proporcionado. */ -->
<?php
...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                                ...
                                <div class="components-preview wide-md mx-auto">     
                                    <div class="nk-block nk-block-lg">
                                        ...
                                        <?php }else{ ?> 
                                            ...
                                            <br>
                                            <!-- /* tabla de categorías con su respectivo ID, nombre, descripción y fecha agregada.
                                            Está utilizando PHP para recorrer una serie de categorías y mostrar su información en la tabla. También
                                            incluye opciones para editar o eliminar cada categoría mediante menús desplegables. */ -->
                                            <table class="table table-orders">
                                                <thead class="tb-odr-head">
                                                    <tr class="tb-odr-item">
                                                        <th class="tb-odr-info">
                                                            <span class="tb-odr-id">ID</span> <!--ID-->
                                                            <span class="tb-odr-date d-none d-md-inline-block">Nombre</span> <!--NOMBRE-->
                                                        </th>
                                                        <th class="tb-odr-amount">
                                                            <span class="tb-odr-date d-none d-md-inline-block">Descripción</span> <!--DESCRIPCION-->
                                                        </th>
                                                        <th class="tb-odr-amount">
                                                            <span class="tb-odr-date d-none d-md-inline-block">Fecha Agregado</span> <!--FECHA AGREGADO-->
                                                        </th>
                                                        ...
                                                        <td class="tb-odr-action">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-xs">
                                                                    <!-- /* genera una lista HTML desordenada con dos elementos de lista. El primer
                                                                    elemento de la lista contiene un hipervínculo a un script PHP que permite editar una categoría. El
                                                                    segundo elemento de la lista contiene un hipervínculo que activa una función de JavaScript
                                                                    para mostrar un modal para eliminar una categoría. El sript PHP y la función JavaScript utilizan las
                                                                    variables  `['id_categoria']` y para pasar datos entre ellas. */ -->
    ...
    variables "id" e "id_tienda". Si los valores no coinciden, muestra un mensaje en un elemento
    HTML con el ID "advertencia". */ -->
    <script> 
