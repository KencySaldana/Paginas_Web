<!-- /verifica si el usuario tiene los permisos necesarios para acceder a la página del
panel. Comprueba si existe la variable de sesión "tipoUsuario" y si cumple con los permisos
requeridos. Si el usuario no tiene los permisos necesarios, se le redirige a la página de inicio de
sesión. El código también recupera algunas estadísticas sobre la tienda (cantidad de categorías,
productos, usuarios y cambios) y el nombre de la tienda según la ID pasada en la URL. */ -->
<?php
...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Menú principal</h3>
                                            
                                        </div><!-- .nk-block-head-content -->
                                        
                                    </div><!-- .nk-block-between -->
                                </div><!-- .nk-block-head -->
                                <div class="nk-block"> <!--INICIO DE CONTENIDO-->
                                    <div class="row g-gs"> 
                                        <div class="col-md-4"> 
                                                ...
                                                <div class="card-inner">
                                                    <div class="card-title-group align-start mb-0">
                                                        <div class="card-title"> <!--TITULO-->
                                                            <h3 class="currency">Total de productos</h3>
                                                        </div>
                                                        <div class="card-tools">
                                                            <em class="card-hint icon ni ni-help-fill" data-bs-toggle="tooltip" data-bs-placement="left" title="Total de productos"></em>
                                                    ...
                                                    <div class="preview-icon card">
                                                        <div class="preview-icon-wrap">
                                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90"> <!--ICONO SVG-->
                                        ...
                                        <div class="col-md-4"> <!--INICIO DE CONTENIDO-->
                                            <div class="card card-bordered card-full">
                                                <div class="card-inner">
                                                    <div class="card-title-group align-start mb-0">
                                                        <div class="card-title">
                                                            <h3 class="currency">Total de usuarios</h3>
                                                        </div>
                                                        <div class="card-tools">
                                                            <em class="card-hint icon ni ni-help-fill" data-bs-toggle="tooltip" data-bs-placement="left" title="Total de usuarios"></em>
                                        ...
                                        <div class="col-md-4"> 
                                            <div class="card card-bordered card-full">
                                                <div class="card-inner">
                                                    <div class="card-title-group align-start mb-0">
                                                        <div class="card-title">
                                                            <h3 class="currency">Total de categorías</h3>
                                                        </div>
                                                        <div class="card-tools">
                                                            <em class="card-hint icon ni ni-help-fill" data-bs-toggle="tooltip" data-bs-placement="left" title="Total de categorías"></em>
                                                        </div>
                                                    </div>
                                                    <div class="card-amount">
                                        ...
                                        <div class="col-md-4">
                                            <div class="card card-bordered card-full">
                                                <div class="card-inner">
                                                    <div class="card-title-group align-start mb-0">
                                                        <div class="card-title">
                                                            <h3 class="currency">Total de cambios realizados</h3>
                                                        </div>
                                                        <div class="card-tools">
                                                            <em class="card-hint icon ni ni-help-fill" data-bs-toggle="tooltip" data-bs-placement="left" title="Total de cambios realizados"></em>
                                                        </div>
                                                    </div>
                                                    <div class="card-amount">
    ...
    <script src="./assets/js/charts/gd-invest.js?ver=3.1.3"></script>
</body>
